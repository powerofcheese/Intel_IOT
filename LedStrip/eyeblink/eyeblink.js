...
var ledstrip = new lib.APA102(100,0);
...
Eyeblinks.prototype.Eyeblink.prototype._draw = function(buf) {
    ...
    ledstrip.setLed(this.startPos,20,buf[this.startPos][0],buf[this.startPos][1],buf[this.startPos][2]);
    ledstrip.setLed(this.startPos+this.eyeSep,20,buf[this.startPos+this.eyeSep][0],
